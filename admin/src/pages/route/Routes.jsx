...
import { getRouteFun } from "../../features/route/routeApi";
...
const Routes = () => {
   ...
   const orderedData = useSelector((state) => state.route.orderData);
   ...
   const { data, isLoading, isError } = useQuery({
     queryKey: ["routes", currentPage, limit, searchQuery, dateValue],
     queryFn: () =>
       getRouteFun({
         limit,
         currentPage,
  ...
  //  console.log(data);
   ...
   const mutation = useMutation({
     ...
     onSuccess: (data) => {
       console.log(data);
       dispatch(deleteRouteFiles(toDelete));
       setToDelete([]);
