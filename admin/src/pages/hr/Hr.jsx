...
import { getHrFun } from "../../features/hr/hrApi";
import { addHr, deleteHrFiles } from "../../features/hr/hrSlice";
...
const Hr = () => {
  ...
  const orderedData = useSelector((state) => state.hr.orderData);
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["hrs", currentPage, limit, searchQuery, dateValue],
    queryFn: () =>
      getHrFun({
        limit,
        currentPage,
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      console.log(data);
      dispatch(deleteHrFiles(toDelete));
      setToDelete([]);
