...
import { getTsoFun } from "../../features/tso/tsoApi";
import {
  addTso,
  deleteTsoFiles,
} from "../../features/tso/tsoSlice";
import { IoMdAdd } from "react-icons/io";
import { getDeleteOrdersFun } from "../../features/order/orderApi";
...
const Tso = () => {
   ...
   const orderedData = useSelector((state) => state.tso.orderData);
   ...
   const { data, isLoading, isError } = useQuery({
     queryKey: ["tso", currentPage, limit, searchQuery, dateValue],
     queryFn: () =>
       getTsoFun({
         limit,
         currentPage,
   ...
   const mutation = useMutation({
     ...
     onSuccess: (data) => {
       console.log(data);
       dispatch(deleteTsoFiles(toDelete));
       setToDelete([]);
